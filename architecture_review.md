...
**Detail-Analyse:**
Die App nutzt aktuell einen **Single-File-Ansatz** (alles in `index.html`). Das bedeutet:
...
1.  **Dateien anlegen:** Die JavaScript-Logik aus `index.html` extrahieren.
...
4.  **ImportMap/Modules:** In `index.html` via `<script type="module" src="js/main.js"></script>` einbinden.
