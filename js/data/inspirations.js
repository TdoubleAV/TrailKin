...
export const inspirationData = {
    ...
    strand: [
        { id: "muschel", itemKey: "inspiration.data.strand.muschel.item", fantasyKey: "inspiration.data.strand.muschel.fantasy" },
        { id: "sandburg", itemKey: "inspiration.data.strand.sandburg.item", fantasyKey: "inspiration.data.strand.sandburg.fantasy" },
        { id: "seetang", itemKey: "inspiration.data.strand.seetang.item", fantasyKey: "inspiration.data.strand.seetang.fantasy" },
        { id: "treibholz", itemKey: "inspiration.data.strand.treibholz.item", fantasyKey: "inspiration.data.strand.treibholz.fantasy" },
        { id: "stein_glanz", itemKey: "inspiration.data.strand.stein_glanz.item", fantasyKey: "inspiration.data.strand.stein_glanz.fantasy" },
        { id: "krabbe", itemKey: "inspiration.data.strand.krabbe.item", fantasyKey: "inspiration.data.strand.krabbe.fantasy" },
        { id: "moewe", itemKey: "inspiration.data.strand.moewe.item", fantasyKey: "inspiration.data.strand.moewe.fantasy" },
        { id: "wellen", itemKey: "inspiration.data.strand.wellen.item", fantasyKey: "inspiration.data.strand.wellen.fantasy" }
    ],
    gebirge: [
        { id: "bergklee", itemKey: "inspiration.data.gebirge.bergklee.item", fantasyKey: "inspiration.data.gebirge.bergklee.fantasy" },
        { id: "edelweiss", itemKey: "inspiration.data.gebirge.edelweiss.item", fantasyKey: "inspiration.data.gebirge.edelweiss.fantasy" },
        { id: "hoehle", itemKey: "inspiration.data.gebirge.hoehle.item", fantasyKey: "inspiration.data.gebirge.hoehle.fantasy" },
        { id: "echo", itemKey: "inspiration.data.gebirge.echo.item", fantasyKey: "inspiration.data.gebirge.echo.fantasy" },
        { id: "gipfelkreuz", itemKey: "inspiration.data.gebirge.gipfelkreuz.item", fantasyKey: "inspiration.data.gebirge.gipfelkreuz.fantasy" },
        { id: "stein_lose", itemKey: "inspiration.data.gebirge.stein_lose.item", fantasyKey: "inspiration.data.gebirge.stein_lose.fantasy" },
        { id: "adler", itemKey: "inspiration.data.gebirge.adler.item", fantasyKey: "inspiration.data.gebirge.adler.fantasy" },
        { id: "wolke_tief", itemKey: "inspiration.data.gebirge.wolke_tief.item", fantasyKey: "inspiration.data.gebirge.wolke_tief.fantasy" }
    ],
    winter: [
        { id: "schneeball", itemKey: "inspiration.data.winter.schneeball.item", fantasyKey: "inspiration.data.winter.schneeball.fantasy" },
        { id: "eiszapfen_groß", itemKey: "inspiration.data.winter.eiszapfen_groß.item", fantasyKey: "inspiration.data.winter.eiszapfen_groß.fantasy" },
        { id: "fährte_schnee", itemKey: "inspiration.data.winter.fährte_schnee.item", fantasyKey: "inspiration.data.winter.fährte_schnee.fantasy" },
        { id: "see_gefroren", itemKey: "inspiration.data.winter.see_gefroren.item", fantasyKey: "inspiration.data.winter.see_gefroren.fantasy" },
        { id: "mistel", itemKey: "inspiration.data.winter.mistel.item", fantasyKey: "inspiration.data.winter.mistel.fantasy" },
        { id: "schneemann", itemKey: "inspiration.data.winter.schneemann.item", fantasyKey: "inspiration.data.winter.schneemann.fantasy" },
        { id: "schlitten", itemKey: "inspiration.data.winter.schlitten.item", fantasyKey: "inspiration.data.winter.schlitten.fantasy" },
        { id: "tannenzweig_schnee", itemKey: "inspiration.data.winter.tannenzweig_schnee.item", fantasyKey: "inspiration.data.winter.tannenzweig_schnee.fantasy" }
    ]
};
